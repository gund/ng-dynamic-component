...
const dynamicComponents: Hashcache<
  any,
  Map<any, IDynamicComponent>
> = new Hashcache<any, Map<any, IDynamicComponent>>(
  () => new Map<any, IDynamicComponent>(),
);
/**
 ...
 */
export function getDynamicComponent<K, V>(
  groupType: K,
  compType: V,
